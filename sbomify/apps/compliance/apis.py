...
@router.get(
    ...
    response={200: SBOMStatusSchema, 403: ErrorResponse, 404: ErrorResponse},
)
...
@router.post(
    ...
    response={200: DocumentSchema, 400: ErrorResponse, 403: ErrorResponse, 404: ErrorResponse},
)
...
@router.get(
    ...
    response={200: StalenessSchema, 403: ErrorResponse, 404: ErrorResponse},
)
