...
interface BSIAssessment {
  ...
  // Issue #902: server-side flag set by sbom_compliance_service
  // when this component's SBOM was generated by sbomify-action.
  // The Step 2 template reads it to suppress the
  // "See sbomify-action enrichment guide" CTA on
  // tooling_limitation findings — re-running the same tool
  // won't fill the gap. False / undefined → CTA renders.
  was_generated_by_sbomify_action?: boolean;
}
