...
_GROUP_ICONS: dict[str, str] = {
    ...
    "Configuration Management": "fa-sliders",
    "Identification and Authentication": "fa-fingerprint",
    "Incident Response": "fa-bell",
    "Maintenance": "fa-wrench",
    "Media Protection": "fa-compact-disc",
    "Personnel Security": "fa-id-badge",
    "Physical Protection": "fa-door-closed",
    "Risk Assessment": "fa-chart-line",
    ...
    "Change Control & Configuration Management": "fa-sliders",
    "Cryptography, Encryption & Key Management": "fa-key",
    "Datacenter Security": "fa-server",
    "Data Security & Privacy Lifecycle Management": "fa-database",
    "Governance, Risk and Compliance": "fa-scale-balanced",
    "Human Resources": "fa-users",
    "Identity & Access Management": "fa-fingerprint",
    "Interoperability & Portability": "fa-right-left",
    "Infrastructure & Virtualization Security": "fa-cloud",
    "Logging and Monitoring": "fa-chart-line",
    "Security Incident Management, E-Discovery, & Cloud Forensics": "fa-bell",
