<template>
  ...
  >
    ...
    <div class="danger-section delete-section">
      <div class="section-header">
        ...
        <div class="section-content">
          ...
          <p class="section-description">Permanently remove this SBOM and all associated data</p>
        </div>
      </div>
      <button
        :id="`del_sbom_${sbomId}`"
    ...
    <DeleteConfirmationModal
      ...
      :item-name="sbomName"
      warning-message="This action cannot be undone and will permanently remove the SBOM and all vulnerability scan data from the system."
...
const handleDeleteConfirm = async (): Promise<void> => {
  try {
    const response = await $axios.delete(`/api/v1/sbom/${props.sbomId}`)
    ...
    showError('Failed to delete SBOM. Please try again.')
  } finally {
