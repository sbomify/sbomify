    ...
    try:
        ...
        if document_file:
            ...
            if file_size is not None and file_size > max_size:
                return 400, {"detail": f"File size must be less than {max_size // (1024 * 1024)}MB"}
        else:
...
def download_document(request: HttpRequest, document_id: str) -> Any:
    ...
    For private documents included in aggregated product SBOMs, signed URLs are used instead
