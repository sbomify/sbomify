...
class TestEvidence:
    def test_a_completed_scan_carries_evidence(self, sample_sbom):  # noqa: F811
        run = _run(sample_sbom)

        assert run_scanned(run) is True

    def test_a_skipped_run_carries_none(self, sample_sbom):  # noqa: F811
    ...
    def test_a_failed_run_carries_none(self, sample_sbom):  # noqa: F811
        run = AssessmentRun.objects.create(
...
class TestOpening:
    def test_a_first_sighting_opens_a_row(self, sample_sbom, sample_component):  # noqa: F811
    ...
    def test_a_second_sighting_does_not_restart_the_clock(self, sample_sbom):  # noqa: F811
    ...
    def test_the_key_is_the_component_not_the_sbom(self, sample_sbom, sample_component):  # noqa: F811
...
class TestResolution:
    def test_a_scan_that_ran_closes_what_it_no_longer_reports(self, sample_sbom):  # noqa: F811
    ...
    def test_a_skipped_run_resolves_nothing(self, sample_sbom):  # noqa: F811
    ...
    def test_a_failed_run_resolves_nothing(self, sample_sbom):  # noqa: F811
        _scan(sample_sbom, "CVE-2021-44228")
    ...
    def test_one_scanner_does_not_close_another_scanners_findings(self, sample_sbom):  # noqa: F811
    ...
    def test_a_returning_finding_reopens_rather_than_duplicating(self, sample_sbom):  # noqa: F811
        _scan(sample_sbom, "CVE-2021-44228")
        _scan(sample_sbom)
...
class TestMetrics:
    def test_age_counts_from_first_sighting_while_open(self, sample_sbom):  # noqa: F811
        _scan(sample_sbom, "CVE-2021-44228")
        row = VulnerabilityLifecycle.objects.get()
    ...
    def test_age_stops_at_resolution_which_is_the_mttr(self, sample_sbom):  # noqa: F811
        _scan(sample_sbom, "CVE-2021-44228")
        row = VulnerabilityLifecycle.objects.get()
        now = timezone.now()
        VulnerabilityLifecycle.objects.filter(pk=row.pk).update(
...
class TestNonVulnerabilities:
    def test_operational_findings_do_not_open_rows(self, sample_sbom):  # noqa: F811
