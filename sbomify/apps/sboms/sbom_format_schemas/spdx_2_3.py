...
#   filename:  https://raw.githubusercontent.com/spdx/spdx-spec/v2.3/schemas/spdx-schema.json
#   timestamp: 2026-01-16T16:28:12+00:00
...
class CreationInfo(BaseModel):
    ...
    licenseListVersion: str | None = Field(
        None,
...
class CrossRef(BaseModel):
    ...
    isValid: bool | None = Field(
        None, description='True if the URL is a valid well formed URL'
    )
    isWayBackLink: bool | None = Field(
        None, description='True if the License SeeAlso URL points to a Wayback archive'
    )
    ...
    order: int | None = Field(
        None, description='The ordinal order of this element within a list'
    )
...
class HasExtractedLicensingInfo(BaseModel):
    ...
    comment: str | None = None
    crossRefs: list[CrossRef] | None = Field(
        None, description='Cross Reference Detail for a license SeeAlso URL'
    )
    ...
    name: str | None = Field(None, description='Identify name of this SpdxElement.')
...
class PackageVerificationCode(BaseModel):
    ...
    packageVerificationCodeExcludedFiles: list[str] | None = Field(
        None,
...
class Package(BaseModel):
    ...
    annotations: list[Annotation1] | None = Field(
        None, description='Provide additional information about an SpdxElement.'
    )
    attributionTexts: list[str] | None = Field(
        None,
    ...
    description: str | None = Field(
        None, description='Provides a detailed description of the package.'
    )
    ...
    hasFiles: list[str] | None = Field(
        None, description='Indicates that a particular file belongs to a package.'
    )
    homepage: str | None = None
    licenseComments: str | None = Field(
        None,
    ...
    licenseConcluded: str | None = Field(
        None,
    ...
    licenseDeclared: str | None = Field(
        None,
    ...
    licenseInfoFromFiles: list[str] | None = Field(
        None,
    ...
    packageFileName: str | None = Field(
        None,
        description='The base name of the package file name. For example, zlib-1.2.5.tar.gz.',
    )
    packageVerificationCode: PackageVerificationCode | None = Field(
        None,
    ...
    primaryPackagePurpose: PrimaryPackagePurpose | None = Field(
        None,
    ...
    summary: str | None = Field(
        None, description='Provides a short description of the package.'
    )
...
class File(BaseModel):
    ...
    annotations: list[Annotation2] | None = Field(
        None, description='Provide additional information about an SpdxElement.'
    )
    artifactOfs: list[dict[str, Any]] | None = Field(
        None,
    ...
    fileContributors: list[str] | None = Field(
        None,
    ...
    fileDependencies: list[str] | None = Field(
        None,
    ...
    fileTypes: list[FileType] | None = Field(None, description='The type of the file.')
    licenseComments: str | None = Field(
        None,
        description='The licenseComments property allows the preparer of the SPDX document to describe why the licensing in spdx:licenseConcluded was chosen.',
    )
    ...
    licenseInfoInFiles: list[str] | None = Field(
        None,
...
class EndPointer(BaseModel):
    ...
    offset: int | None = Field(None, description='Byte offset in the file')
    lineNumber: int | None = Field(None, description='line number offset in the file')
...
class Snippet(BaseModel):
    ...
    annotations: list[Annotation3] | None = Field(
        None, description='Provide additional information about an SpdxElement.'
    )
    attributionTexts: list[str] | None = Field(
        None,
    ...
    licenseInfoInSnippets: list[str] | None = Field(
        None,
...
class Spdx23(BaseModel):
    ...
    documentNamespace: str | None = Field(
        None,
    ...
    documentDescribes: list[str] | None = Field(
        None,
        description='Packages, files and/or Snippets described by this SPDX document',
    )
    packages: list[Package] | None = Field(
        None, description='Packages referenced in the SPDX document'
    )
    files: list[File] | None = Field(
        None, description='Files referenced in the SPDX document'
    )
    snippets: list[Snippet] | None = Field(
        None, description='Snippets referenced in the SPDX document'
    )
    relationships: list[Relationship] | None = Field(
        None, description='Relationships referenced in the SPDX document'
    )
