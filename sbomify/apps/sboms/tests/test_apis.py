...
def test_web_upload_vex_reissue_allowed_and_enqueues_reapply(
    ...
    mocker.patch("boto3.resource")
    mocker.patch("sbomify.apps.core.object_store.StorageClient.upload_data_as_file")
    mocker.patch("sbomify.apps.core.object_store.StorageClient.upload_sbom", return_value="stored.json")
    send = mocker.patch("sbomify.apps.vulnerability_scanning.tasks.reapply_vex_to_component_scans.send")
    SBOM.objects.all().delete()
        ...
        "@graph": [
            {
                ...
                "createdBy": ["urn:example:creator"],
            },
            {
                "type": "Organization",
                "creationInfo": "_:creationInfo",
                "spdxId": "urn:example:creator",
                "name": "Test Creator",
            },
            # SpdxDocument deliberately without `name` — spec-legal per 3.0.1.
            {
                "type": "SpdxDocument",
                "creationInfo": "_:creationInfo",
                "spdxId": "urn:example:document",
                "rootElement": ["urn:example:package-primary"],
            },
            {
                "type": "software_Package",
                "creationInfo": "_:creationInfo",
                "spdxId": "urn:example:package-primary",
                "name": "primary-pkg",
                ...
                "externalIdentifier": [
                    {
                        ...
                        "identifier": "pkg:pypi/primary-pkg@1.0.0",
                    },
                ],
            },
        ],
        ...
        "@graph": [
            {
                ...
                "createdBy": ["https://example.com/empty#tool"],
            },
            {
                "type": "Tool",
                "creationInfo": "_:creationInfo",
            ...
            },
            {
                ...
                "rootElement": ["https://example.com/empty#tool"],
            },
        ],
    }
