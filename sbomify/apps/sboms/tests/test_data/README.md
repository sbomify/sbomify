...
the Yocto Project's own autobuilder. All three are the published artefacts byte
for byte — only the filenames differ, to match the naming used in this
directory, and one is gzipped for size. Background:
...
| 5.0.19 `core-image-minimal` (SPDX 2.2) | — | 233 | 0 | 102 | 131 |
