...
class TestTeamGeneralView:
    ...
    def test_rename_refreshes_the_cached_workspace_list(self, client: Client, sample_team_with_owner_member):
    ...
    def test_set_default_workspace(self, client: Client, sample_team_with_owner_member):
    ...
    def test_set_default_requires_owner(self, client: Client, sample_team_with_owner_member):
    ...
    def test_delete_workspace(self, client: Client, sample_team_with_owner_member):
    ...
    def test_delete_default_workspace_fails(self, client: Client, sample_team_with_owner_member):
    ...
    def test_delete_workspace_requires_owner(self, client: Client, sample_team_with_owner_member):
    ...
    def test_delete_workspace_switches_to_default(self, client: Client, sample_team_with_owner_member):
    ...
    def test_update_workspace_name(self, client: Client, sample_team_with_owner_member):
    ...
    def test_update_workspace_name_allows_admin(self, client: Client, sample_team_with_owner_member):
    ...
    def test_setting_the_freshness_window(self, client: Client, sample_team_with_owner_member):
    ...
    def test_clearing_the_freshness_window_removes_the_policy(self, client: Client, sample_team_with_owner_member):
    ...
    def test_a_zero_day_window_is_stored_not_treated_as_unset(self, client: Client, sample_team_with_owner_member):
    ...
    def test_a_negative_window_is_rejected(self, client: Client, sample_team_with_owner_member):
        team = sample_team_with_owner_member.team
        setup_authenticated_client_session(client, team, sample_team_with_owner_member.user)
    ...
    def test_the_window_round_trips_to_the_form(self, client: Client, sample_team_with_owner_member):
        team = sample_team_with_owner_member.team
        ...
        response = client.get(
            reverse("teams:team_general", kwargs={"team_key": team.key}), headers={"hx-request": "true"}
        )
