    ...
    def get(self, request: HttpRequest, team_key: str) -> HttpResponse:
        ...
        return render(
            ...
            "teams/team_settings.html.j2",
            {
                ...
                "available_catalogs": [
                    ("soc2-type2", "SOC 2 Type II", "fa-shield-halved"),
                    ("iso27001-2022", "ISO 27001:2022", "fa-certificate"),
                    ("nist-csf-2", "NIST Cybersecurity Framework 2.0", "fa-landmark"),
                    ("cis-controls-v8", "CIS Controls v8", "fa-lock"),
                    ("hipaa", "HIPAA", "fa-heart-pulse"),
                    ("gdpr", "GDPR", "fa-user-shield"),
                    ("cmmc-2", "CMMC 2.0", "fa-jet-fighter"),
                    ("csa-ccm-v4", "CSA CCM", "fa-cloud"),
                    ("pci-dss-v4", "PCI DSS", "fa-credit-card"),
                ],
