...
class TestUniqueConstraints:
    def test_duplicate_project_name_in_same_team(self, sample_team_with_owner_member):
    ...
    def test_duplicate_product_name_in_same_team(self, sample_team_with_owner_member):
    ...
    def test_duplicate_component_name_in_same_team(self, sample_team_with_owner_member):
