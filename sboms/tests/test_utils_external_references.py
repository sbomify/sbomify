...
from core.models import Component, User, Product
...
class TestExternalReferenceUtils:
    ...
    def test_get_spdx_category_for_product_link(self):
        ...
        from sboms.utils import _get_spdx_category_for_product_link
    ...
    def test_get_spdx_type_for_product_link(self):
        ...
        from sboms.utils import _get_spdx_type_for_product_link
